...
//
// Layout: ~/.tinyplace-codex/sessions/<agent-address>/<label>.json
...
//   3. the lowest-free `codex:<n>` among live sessions.
...
// could both pick the same free `codex:n` before either file exists, and the
